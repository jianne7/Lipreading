...
if __name__ == '__main__':
    ...
    # accelerator 
    train_loader, valid_loader, model, optimizer = accelerator.prepare(
    ...
    for epoch in range(0, epochs):
        ...
        if accelerator.is_local_main_process:
            av_model = accelerator.unwrap_model(model)

            save(os.path.join('checkpoint', f"model_{epoch:03d}.pt"), model=av_model, optimizer=None, logger=logger)
